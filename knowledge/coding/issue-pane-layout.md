...
description: Layout conventions for keeping issue metadata compact while giving plan, review, queue messages, and agent logs the flexible space they need.
keywords: [Issue view, overview issue detail, item detail, fixed metadata header, Agent Log, plan checklist, review findings, queue messages, phase detail, ratatui layout, TUI labels, compact metadata]
created: 2026-06-17
modified: 2026-06-24
---
...
| Operator console target | item detail sections: Detail, Findings, Tasks, Queue messages, Log |
...
| steering/follow-up guidance | Queue messages |
